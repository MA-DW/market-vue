...
import ImageUserPath from '../images/usuario-de-perfil.png';

export const sygnet = [
  '300 100',
  `
    <svg xmlns="http://www.w3.org/2000/svg" width="300" height="100" viewBox="0 0 300 100">
      <image href="${ImageUserPath}" width="80" height="80" x="10" y="18" />
      <text x="100" y="58" font-family="Arial, sans-serif" font-size="24" fill="white">USER NAME</text>
      <text x="100" y="88" font-family="Arial, sans-serif" font-size="18" fill="#cccccc">My Panel</text>
    </svg>
  `
]